...
Adapted from girving-ray for the pphi2 project.
...
import Pphi2.GeneralResults.Osgood.Multilinear
...
theorem mem_sphere_closed {z c : ℂ} {r : ℝ} : z ∈ sphere c r → z ∈ closedBall c r :=
  fun h => Metric.sphere_subset_closedBall h
